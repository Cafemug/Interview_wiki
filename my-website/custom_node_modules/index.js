...
module.exports = async function(fileString) {
  ...
  // ---\n
  const middleIndex = fileString.indexOf("---", 5) + 4;
  const addAdsense =`${fileString.substring(0, middleIndex)}
...
${fileString.substring(middleIndex, fileString.length)}
...
/>`;
  ...
  const {data, content} = matter(addAdsense);
